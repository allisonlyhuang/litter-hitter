...
function App() {
  ...
  if (currentPage === 'loading') {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center" style={{ backgroundColor: '#0a130c' }}>
        ...
        <span className="text-xs font-semibold uppercase tracking-widest animate-pulse" style={{ color: '#d89d57' }}>
          Loading Litter Hitter…
        </span>
      </div>
    );
  }
